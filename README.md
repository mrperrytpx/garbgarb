...
<img src="readme/homepage.png" alt="Homepage." width="500">
...
<img src="readme/shop.png" alt="Shop page." width="500">
...
<img src="readme/product.png" alt="Product page." width="500">
...
<img src="readme/cart.png" alt="Cart page." width="500">
...
<img src="readme/checkout1.png" alt="Checkout page, step 1." width="500">
...
<img src="readme/checkout2a.png" alt="Checkout page, step 2, all products are in stock." width="500">
<img src="readme/checkout2b.png" alt="Checkout page, step 2, some product names are struck-through because they're not in stock anymore." width="500">
...
<img src="readme/checkout3a.png" alt="Checkout page, step 3, showing errors in the field if the user didn't fill in some of them." width="500">
<img src="readme/checkout3b.png" alt="Checkout page, step 3, showing google address auto suggestions." width="500">
...
<img src="readme/checkout4.png" alt="Checkout page, step 4." width="500">

After the checkout is successful, user is greeted with a Success page and the order is made.

<img src="readme/success.png" alt="Order success page." width="400">
...
<img src="readme/profile.png" alt="Profile page, containing an outgoing order." width="500">
...
<img src="readme/order.png" alt="Order page, showing an outgoing order" width="500">

Once the order is canceled, information about it will become greyed out.

<img src="readme/order-canceled.png" alt="Order page, showing a canceled order." width="500">
