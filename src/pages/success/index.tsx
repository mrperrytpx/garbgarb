...
const AnimatedCheckmark = () => {
    ...
    return (
        <div className="relative flex h-20 w-20 items-center justify-center rounded-full border-2 border-black  p-4">
            <AiOutlineCheck size="52" fill="black" />
            <div className="absolute top-0 left-0 h-1/2 w-1/2 translate-x-1/2 translate-y-1/2 rotate-180">
                <div
                    style={{
                        width: mounted ? "0%" : "100%",
                    }}
                    className="transition-width h-full bg-white duration-500"
                ></div>
            </div>
        </div>
    );
