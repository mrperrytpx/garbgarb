...
const PrivacyPage = () => {
    return (
        <>
            <Head>
                <title>GarbGarb - Privacy Policy</title>
            </Head>
            <div className="mx-auto mb-20 mt-10 flex w-full max-w-screen-md flex-1 flex-col gap-6 p-4 text-gray-200">
                ...
                <p className="text-sm">
                    At GarbGarb, we take your privacy seriously. This policy explains how we
                    collect, process, and share your personal information when you use our services
                    or visit our Website.
                </p>
                <article className="flex flex-col items-start gap-2">
                    <h2 className="font-semibold underline">Personal Information Collection</h2>
                    <p className="text-sm">
                        When you visit this Website, we automatically collect certain information
                    ...
                    <p className="text-sm">
                        ...
                        information from you, which includes your name, billing and shipping
                        address, payment details (like credit card numbers), email address, and
                        phone number. We refer to this information as "Order Information".
                    </p>
                    <p className="text-sm">
                        In this Privacy Policy, the term "Personal Information" encompasses both
                ...
                <article className="flex flex-col items-start gap-2">
                    ...
                    <p className="text-sm">
                        ...
                        shipping, and providing invoices and order confirmations. We also utilize
                        this information to:
                    </p>
                    ...
                    <p className="text-sm">
                        ...
                        generally to improve and optimize our Website (for example, by generating
                        analytics about how our customers browse and interact with the Website)
                    </p>
                </article>
                <article className="flex flex-col items-start gap-2">
                    <h2 className="font-semibold underline">How We Share Your Personal Data</h2>
                    <p className="text-sm">
                        We may share your Personal Information with third-party services to
                        facilitate our use of your information, as outlined previously.
                    </p>
                    <p className="text-sm">
                    ...
                    <p className="text-sm">
                        Additionally, we may disclose your Personal Information in response to
                        lawful requests for information, including compliance with applicable laws
                        and regulations or to protect our legal rights.
                    </p>
                </article>
                <article className="flex flex-col items-start gap-2">
                    ...
                    <p className="text-sm">
                        ...
                        example if you make an order through the Website), or otherwise to pursue
                ...
                <article className="flex flex-col items-start gap-2">
                    ...
                    <p className="text-sm">
                        ...
                        updated Privacy Policy on our website and update the Effective Date at the
                        top of the Privacy Policy.
                    </p>
                    <p className="text-sm">
                        Your continued use of our website after we make changes is deemed to be
                        acceptance of those changes, so please check the Privacy Policy periodically
                        for updates.
                    </p>
                </article>
                <article className="flex flex-col items-start gap-2">
                    ...
                    <p className="text-sm">
                        ...
                        practices regarding personal data, please{" "}
                        <Link href="/static/contact">
                            <strong>
                                <u>Contact us</u>
                            </strong>
