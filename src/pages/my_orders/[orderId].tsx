...
const OrderPage = () => {
    ...
    return (
        <div className="mx-auto my-2 flex w-full max-w-screen-sm flex-1 flex-col gap-2">
            ...
            <div className="mb-10 mt-4 flex flex-col gap-4 px-2">
                <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <p className="text-sm uppercase">{orderData.data?.status}</p>
                </div>
                <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            {orderData.data.status !== "canceled" && (
                <div className="px-2">
                    <button
                        ...
                        className="mt-auto w-full rounded-lg p-2 text-center font-bold uppercase shadow disabled:opacity-30 sm:m-0 sm:w-32"
                    >
                        {cancelOrderMutation.isLoading ? <LoadingSpinner /> : "CANCEL"}
                    </button>
                </div>
            )}
        </div>
