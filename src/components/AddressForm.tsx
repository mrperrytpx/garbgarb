                ...
                status === "OK" && (
                  ...
                  >
                    {data.map((suggestion, i) => (
                      ...
                      >
                        <strong className="uppercase">{suggestion.description}</strong>
                      </li>
                    ))}
                  </ul>
                )
            ...
            <div className="flex flex-1 gap-2">
              <div className="flex w-full flex-col self-start sm:w-auto">
                <label className="block p-1 text-sm" htmlFor="streetNumber">
                  <strong className="uppercase">Street Number</strong>
                </label>
                <input
            ...
            <div className="flex gap-2">
              ...
              <div className="w-full">
                <label className="block p-1 text-sm" htmlFor="province">
                  <strong className="uppercase">State / Province</strong>
                </label>
                <input
                  {...register("province")}
                  name="province"
            ...
            <div className="flex gap-2">
              ...
              <div className="w-full">
                <label className="block p-1 text-sm" htmlFor="zip">
                  <strong className="uppercase">Zip / Postal Code</strong>
                </label>
                <input
                  {...register("zip")}
                  name="zip"
