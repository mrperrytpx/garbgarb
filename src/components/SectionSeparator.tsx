...
export const SectionSeparator = ({ number, name, checkoutStep }: ISectionSeparator) => {
    return (
        <div className="mt-2 flex w-full flex-col items-center justify-center gap-1 text-gray-200">
        ...
        /> */}
                <span
                    ...
                    className="relative z-10 inline-flex h-8 w-8 items-center justify-center rounded-full border-2 border-slate-200 bg-black text-lg font-bold transition-all sm:h-10 sm:w-10 "
                >
                    {number}
                </span>
                {/* <span
        ...
        /> */}
                <span
                    ...
                    className="absolute left-0 right-0 top-1/2 h-0.5 w-0 -translate-y-1/2 transform bg-slate-200 opacity-100 transition-all duration-300"
                />
            </div>
            <div
                style={{
