    ...
    return (
        ...
        /> */}
                <span
                    ...
                    className="relative z-10 inline-flex h-8 w-8 items-center justify-center rounded-full border bg-black text-lg font-bold transition-all sm:h-10 sm:w-10 "
                >
                    {number}
                </span>
                {/* <span
        ...
        /> */}
                <span
                    ...
                    className="absolute top-1/2 right-0 left-0 h-0.5 w-0 -translate-y-1/2 transform bg-slate-200 opacity-100 transition-all duration-300"
                />
            </div>
            <div
                style={{
